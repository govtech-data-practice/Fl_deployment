"""Logistic Regression ClientApp — simplest baseline, excellent DP tolerance."""
import sys, os
...
from tasks.hfl.readmission.data import prepare_federated_data

logger = logging.getLogger("logreg.client")
...
class LogRegClient(fl.client.NumPyClient):
    def __init__(self, pid, n_clients, input_dim=20):
...
def client_fn(context: Context) -> Client:
    ...
    return LogRegClient(pid, n).to_client()
