"""Simple TabNet ClientApp — attention-based tabular model for mortality prediction."""
import sys, os
...
from tasks.hfl.mortality.data import prepare_federated_data

logger = logging.getLogger("tabnet_simple.client")
...
class TabNetClient(fl.client.NumPyClient):
    def __init__(self, pid, n_clients, input_dim=25):
...
def client_fn(context: Context) -> Client:
    ...
    return TabNetClient(pid, n).to_client()
