"""1D CNN ClientApp — time-series classification (ECG, multi-class)."""
import sys, os
...
from tasks.hfl.ecg.data import prepare_federated_data

logger = logging.getLogger("cnn1d.client")
...
class CNN1DClient(fl.client.NumPyClient):
    def __init__(self, pid, n_clients, in_channels=12, num_classes=4):
...
def client_fn(context: Context) -> Client:
    ...
    return CNN1DClient(pid, n).to_client()
