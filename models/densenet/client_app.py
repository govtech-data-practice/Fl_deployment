...
def _load(pid, n_clients, ptype, alpha, synthetic, dataset_path, csv_path):
    ...
    if synthetic:
        ...
        from tasks.chest_xray.data import partition_data_dynamic, CLASSES
...
class ChestClient(fl.client.NumPyClient):
    ...
    def set_parameters(self, params):
        ...
        self.model.load_state_dict({k: torch.tensor(np.array(v), device=DEVICE) for k, v in sd.items()}, strict=True)
